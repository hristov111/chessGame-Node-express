...
repeatpassCheckbox.addEventListener('change', () => {
    repeatpassCheckbox.checked === true? repeatPasswordInputBox = 'text': repeatPasswordInputBox  = 'password';
})
...
repeatPasswordInputBox.addEventListener('input', (event) => {
    ...
    if(totalText === ''){
        ...
        repeatpassCheckbox.style.display = 'none';
        return;
    }
    repeatpassCheckbox.style.display = 'block';
